...
async function AppointmentInfo(question, phone) {
    try {
        ...
        const openaiResponse = await openai.chat.completions.create({
            model: "gpt-3.5-turbo",
            messages: [
                { role: "system", content: "Eres un asistente que ofrece informacion sobre las consultas agendadas en el consultorio de la doctora Jennifer la cual es Ginecologa y Mastologa, debes buscar si el paciente tiene una cita agendada para poder retornarle toda la información sobre su cita. Retorna solo los datos de la cita si los encontraste. Si el paciente no tiene cita puedes indicarle que puede agendar mediante nuestro portal de agenda el cual es: http://localhost:3000/appointments/public/create o llamando a nuestro telefono el cual es: (809) 769 - 5217 las llamadas unicamente dentro de nuestro horario de Lunes a Viernes de 9:00 AM a 5:00 PM. No se pueden agendar citas por whatsapp, si el paciente no tiene cita envialo a la web." },
                {
                    role: "user",
